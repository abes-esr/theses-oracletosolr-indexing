...
l_host_name        VARCHAR2 (128)   := 'xxxxxxxxxxxxxxxx.fr';
...
BEGIN
    ...
    l_response := apex_web_service.make_rest_request(
        p_url => 'http://serveur:port/indexationsolr/GetSuppressionSolr?iddoc='||iddoc||'&contexte=portail',
        p_http_method => 'GET');
...
l_raw_data         RAW (512);
l_clob_response    CLOB;
l_host_name        VARCHAR2 (128)   := 'xxxxxxxxxxxx.fr';
